...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "production" do |production|
    ...
    production.vm.network "forwarded_port", guest: 8000, host: 1234
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo apt install -y php php-bcmath php-cli php-curl php-zip php-sqlite3 php-mysql php-xml php-mbstring
